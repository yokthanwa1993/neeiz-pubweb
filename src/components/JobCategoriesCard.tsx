const JobCategoriesCard = () => (
  <article className="md:aspect-square flex flex-wrap content-start gap-2 sm:gap-3 hover:border-gray-600 hover:shadow-lg transition-all duration-300 hover:-translate-y-2 bg-gray-800 border border-gray-700 rounded-3xl p-6 sm:p-8">
