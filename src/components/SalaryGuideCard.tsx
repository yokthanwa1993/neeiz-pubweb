...
const SalaryGuideCard = () => (
  <article className="flex flex-col group hover:border-theme/50 hover:shadow-lg transition-all duration-300 hover:-translate-y-2 bg-gray-800 border border-gray-700 rounded-3xl p-6 sm:p-8 justify-between min-h-[360px]">
