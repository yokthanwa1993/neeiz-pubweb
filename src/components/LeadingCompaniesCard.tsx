...
const LeadingCompaniesCard = () => (
  <article className="flex flex-col group hover:shadow-lg transition-all duration-300 hover:-translate-y-2 text-white bg-gray-800/80 border border-gray-700 rounded-3xl p-6 sm:p-8 justify-between min-h-[360px]">
